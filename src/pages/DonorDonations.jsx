...
import { FaTint, FaFilter, FaEye } from 'react-icons/fa';
      ...
      {filteredDonations.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredDonations.map((donation) => (
            <div key={donation.id} className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                    <div>
                      ...
                      <p className="font-semibold">{donation.BloodRequest?.blood_type || 'N/A'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Quantity</p>
                      <p className="font-semibold">{donation.BloodRequest?.quantity || 'N/A'} units</p>
                    </div>
                    <div>
